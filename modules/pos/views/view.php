...
<body>
<div id="wrapper">
    <img class="left" style="margin-bottom:10px;" src="<?php echo $this->config->base_url(); ?>assets/uploads/logos/<?php echo $biller->logo; ?>" alt="Biller Logo">
    
    <h3 style="text-transform:uppercase;margin-left: -50px;"><?php echo $biller->company; ?></h3>
	<?php echo "<p class=\"left\" style=\"text-transform:capitalize;margin-top:-2px;\"> P.O. Box ".$biller->postal_code."<br/>".$biller->address.",<br/>".$biller->city.", ".$biller->country."<br/><br/></p>"; 

...
*/
	...
	function getdatatableajaxcost()
   {
	   ...
	   $this->datatables
			->select("products.id as productid, products.image as image, products.code as code, products.name as name, categories.name as cname, products.cost, products.price, (CASE WHEN sum(warehouses_products.quantity) Is Null THEN 0 ELSE sum(warehouses_products.quantity) END) as totalQuantity, products.unit, alert_quantity")
			->from('products')
